...
use Concludis\ApiClient\V2\Responses\CompaniesCompanyPatchResponse;

class CompaniesCompanyPatchEndpoint extends AbstractEndpoint {
    ...
    /**
     * @return CompaniesCompanyPatchResponse
     */
    public function call(): CompaniesCompanyPatchResponse {
        ...
        return new CompaniesCompanyPatchResponse($this, $response);
    }
